...
import HtmlImage from "../../../public/HTML.jpg";
import "./Heroui.css";
function Heroui() {
  const features = [
    {
      name: "441,585 students",
      icon: (
        <svg
      ...
      <div className="max-w-screen-xl mx-auto px-4 gap-12 text-gray-600 md:px-8 xl:flex">
        ...
        <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
          <div className="relative">
            <img src={HtmlImage} className="rounded-lg" alt="" />
            <button
      ...
      {isVideoPoppedUp ? (
        <div className="fixed inset-0 w-full h-full flex items-center justify-center">
          ...
          <div className="px-4 relative">
            ...
            >
              <source
                src="https://res.cloudinary.com/dssmfqqmt/video/upload/v1739706708/001course_hluj34.mp4"
                type="video/mp4"
              />
            </video>
          </div>
