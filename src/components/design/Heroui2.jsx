...
import JsImage from "../../../public/JS.jpg";
import "./Heroui2.css";
function Heroui2() {
  const features = [
    {
      name: "970,591 students",
      icon: (
        <svg
  ...
  return (
    <Section crosses>
      <div className="max-w-screen-xl mx-auto px-4 gap-12 text-gray-600 md:px-8 xl:flex">
        <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
          <div className="relative">
            <img src={JsImage} className="rounded-lg" alt="" />
            <button
        ...
        <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
          ...
          <h1 className="text-2xl text-n-1 font-bold mx-auto md:text-5xl">
      ...
      {isVideoPoppedUp ? (
        <div className="fixed inset-0 w-full h-full flex items-center justify-center">
          ...
          <div className="px-4 relative">
            ...
            >
              <source
                src="https://res.cloudinary.com/dssmfqqmt/video/upload/v1739706880/002course_vn0cur.mp4"
                type="video/mp4"
              />
            </video>
          </div>
